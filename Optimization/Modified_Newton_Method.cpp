...
double gradient_x1 (double x1, double x2);

double gradient_x1 (double x1, double x2)
{
       double d = (f(x1 + 0.00001, x2) - f(x1,x2)) / 0.00001; 
       return d;
}

double gradient_x2 (double x1, double x2);

double gradient_x2 (double x1, double x2)
{
       double d = (f(x1, x2 + 0.00001) - f(x1,x2)) / 0.00001; 
       return d;
}

double hesian_x1_x1 (double x1, double x2);

double hesian_x1_x1 (double x1, double x2)
{
       double d = (gradient_x1(x1 + 0.00001, x2) - gradient_x1(x1,x2)) / 0.00001; 
       return d;
}

double hesian_x1_x2 (double x1, double x2);

double hesian_x1_x2 (double x1, double x2)
{
       double d = (gradient_x1(x1 , x2 + 0.00001) - gradient_x1(x1,x2)) / 0.00001; 
       return d;
}

double hesian_x2_x1 (double x1, double x2);

double hesian_x2_x1 (double x1, double x2)
{
       double d = (gradient_x2(x1 + 0.00001 , x2 ) - gradient_x2(x1,x2)) / 0.00001; 
       return d;
}

double hesian_x2_x2 (double x1, double x2);

double hesian_x2_x2 (double x1, double x2)
{
       double d = (gradient_x2(x1 , x2 + 0.00001) - gradient_x2(x1,x2)) / 0.00001; 
       return d;
}
...
int main()
{
    ...
    fstream fout("Output_Modified_Newton_Method.txt", ios :: out);
    fstream fo("Output_Modified_Newton_Method.xls", ios :: out);
    ...
    while (mod >= epsilon)
    {
          ...
          //gradient[0] = (f(x1+0.001,x2) - f(x1,x2)) / 0.001 ;
          //gradient[1] = (f(x1,x2+0.001) - f(x1,x2)) / 0.001 ;   
          //cout<<gradient[0]<<"  "<<gradient[1]<<"\n\n";
          mod = sqrt((gradient_x1(x1,x2) * gradient_x1(x1,x2)) + (gradient_x2(x1,x2) * gradient_x2(x1,x2)));
          //cout<<mod<<"\n\n";
          if(mod < epsilon)
          {
          ...
          d[0] = (-(hesian_x2_x2(x1,x2) * gradient_x1(x1,x2)) + (hesian_x1_x2(x1,x2) * gradient_x2(x1,x2))) / ((hesian_x1_x1(x1,x2) * hesian_x2_x2(x1,x2)) - (hesian_x1_x2(x1,x2) * hesian_x2_x1(x1,x2)));
          d[1] = ((hesian_x2_x1(x1,x2) * gradient_x1(x1,x2)) - (hesian_x1_x1(x1,x2) * gradient_x2(x1,x2))) / ((hesian_x1_x1(x1,x2) * hesian_x2_x2(x1,x2)) - (hesian_x1_x2(x1,x2) * hesian_x2_x1(x1,x2)));
